...
const userRegisterSchema = z.object({
  ...
  phone: z.string().length(10, { message: "Phone number must be exactly 10 digits long" }).regex(/^0\d{9}$/, { message: "Phone number must start with 0 and contain only digits" }),
